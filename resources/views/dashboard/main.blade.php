                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat text-bg-pink">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase mt-0" title="Customers">Date and Time today</h6>
                                        <h2 class="my-2"> <style>
                                            /* Style the container for time and date */
                                            #datetime {
                                              font-size: 24px;
                                              text-align: center;
                                              margin-top: 50px;
                                          ...
                                          <script>
                                            ...
                                            function updateTime() {
                                              var now = new Date();
                                              var dateTimeString = now.toLocaleString(); // Get date and time in local format
                                        ...
                                        <p class="mb-0">
                                            <span class="badge bg-white bg-opacity-10 me-1">System </span>
                                            <span class="text-nowrap">Timer</span>
                                        </p>
                                    </div>
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat text-bg-purple">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-uppercase mt-0" title="Customers">Welcome</h6>
                                        <h2 class="my-2">
                                        ...
                                        <p class="mb-0">
                                            <span class="badge bg-white bg-opacity-10 me-1">System</span>
                                            <span class="text-nowrap">User</span>
                                        </p>
                                    </div>
                                </div>
                            </div> <!-- end col-->
