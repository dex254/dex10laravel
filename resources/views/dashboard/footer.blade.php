    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
                <script>document.write(new Date().getFullYear())</script> © 👤👤 - Developed by <b>Dex@254</b>
            </div>
        </div>
    </div>
</footer>
...
<div data-simplebar class="h-100">
    <div class="p-3">
        ...
        <div id="layout-position">
            <h5 class="my-3 fs-16 fw-bold"> Dex Layout Position</h5>
...
<!-- Mirrored from themes.getappui.com/techzaa/velonic/layouts/index-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Apr 2024 09:44:06 GMT -->
</html> 
