...
<!-- Mirrored from themes.getappui.com/techzaa/velonic/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Apr 2024 09:44:54 GMT -->
<head>
    <meta charset="utf-8" />
                                           ...
                                           <div class="mb-3">
                                            ...
                                            <div class="text-center mt-4">
                                                ...
                                                <div class="d-flex gap-2 justify-content-center mt-3">
                                                    <a href="http://127.0.0.1:8000/admin" class="btn btn-soft-primary"><button type="button" class="btn btn-outline-primary">
                                                        login As admin</button> </a>
                                                        <a href="http://127.0.0.1:8000/login" class="btn btn-soft-dark"> <button type="button" class="btn btn-outline-warning">
